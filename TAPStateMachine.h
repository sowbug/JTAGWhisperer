...
#ifndef INCLUDE_JTAG_WHISPERER_TAP_STATE_MACHINE_H
#define INCLUDE_JTAG_WHISPERER_TAP_STATE_MACHINE_H
...
class TAPStateMachine {
 public:
 TAPStateMachine(BitTwiddler& twiddler)
   : twiddler_(twiddler),
    current_state_(-1),
    sdrsize_bits_(0),
    sdrsize_bytes_(0),
...
#endif  // INCLUDE_JTAG_WHISPERER_TAP_STATE_MACHINE_H
